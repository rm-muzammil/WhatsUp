export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen bg-[#111b21] flex flex-col">
      {/* Green top bar like WhatsApp */}
      <div className="h-32 bg-[#00a884]" />

      <div className="flex-1 flex items-start justify-center px-4 -mt-16">
        <div className="w-full max-w-md bg-[#1f2c34] rounded-lg shadow-xl p-8">
          {/* Logo */}
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-white text-2xl font-light tracking-wide">WhatsApp</h1>
          </div>
